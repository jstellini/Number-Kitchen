...
// Built from one shared kit — a round body, a face, two arms — with a bespoke
// colour and hat each, in the spirit of ABC Town's build_characters.py.
const CAST = [
  { id: 'pip',    name: 'Pip',    color: '#ff8a3d', hat: 'chef' },
  { id: 'bea',    name: 'Bea',    color: '#4fc3f7', hat: 'beret' },
  { id: 'ollie',  name: 'Ollie',  color: '#81c784', hat: 'cap' },
  { id: 'mimi',   name: 'Mimi',   color: '#f06292', hat: 'bow' },
  { id: 'gus',    name: 'Gus',    color: '#ffd54f', hat: 'chef' },
  { id: 'nell',   name: 'Nell',   color: '#9575cd', hat: 'beret' },
];
